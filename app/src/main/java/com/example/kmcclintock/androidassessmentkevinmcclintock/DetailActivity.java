 ...
 * Class used for once the user clicks on a image
 * The image will animate to the front of the screen and display an image
 * as well as the name of the product,price and currency.
 */
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String cur = bundle.getString("cur");
        Double amount = bundle.getDouble("amount");

        //initialize and set the views
        titleTextView = (TextView) findViewById(R.id.Text_title);
        titleTextView.setText(title);
        curTextView = (TextView) findViewById(R.id.Text_Cur);
        curTextView.setText(cur);
        amountTextView = (TextView) findViewById(R.id.Text_Amt);
